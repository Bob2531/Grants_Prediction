...
if sys.argv[1] == 'train':
    lines = readFromFile.readLines('../data/train/borrow_train_invert.txt')
elif sys.argv[1] == 'test':
    lines = readFromFile.readLines('../data/test/borrow_final_test_invert.txt')
else:
...
with open('../data/test/BorrowProcessed.txt', 'w') as fw:
    fw.write(students)
