...
if sys.argv[1] == 'train':
    lines = readFromFile.readLines('../data/train/dorm_train_invert.txt')
elif sys.argv[1] == 'test':
    lines = readFromFile.readLines('../data/test/dorm_final_test_invert.txt')
else:
...
fw = open('../data/test/DormProcessed.txt', 'w')
#count = 0
for line in lines:
    '''
        Features:
